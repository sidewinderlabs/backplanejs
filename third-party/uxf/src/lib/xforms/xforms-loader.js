...
(
  function(){
	...
	loader.addModule({
		name: "ux-default-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/default.css",
	...
	loader.addModule({
		name: "xforms-utils",
		type: "js",
		fullpath: moduleBase + "../UXUtils.js"
	});

	loader.addModule({
		name: "xforms-vertex-target",
		type: "js",
		fullpath: moduleBase + "VertexTargets.js",
		requires: ["yahoo"]
	});
	loader.addModule({
		name: "xforms-state",
	...
	loader.addModule({
		name: "dirtystate",
		type: "js",
		fullpath: moduleBase + "dirtystate.js"
	});
	loader.addModule({
		name: "xforms-mip-handler",
		type: "js",
		fullpath: moduleBase + "mip-handler.js",
		requires: ["dirtystate"]
	});
	loader.addModule({
		name: "xforms-mip-eventtarget",
		type: "js",
		fullpath: moduleBase + "mip-eventtarget.js",
	...
	loader.addModule({
		name: "xforms-model",
		type: "js",
		fullpath: moduleBase + "modelObj.js",
	...
	loader.addModule({
		name: "xforms-submission",
		type: "js",
		fullpath: moduleBase + "Submission.js",
		requires: ["libxh-xlink", "xforms-processor", "xforms-submission-core", "libxh-namespace-manager"]
	});

	loader.addModule({
		name: "xforms-processor",
		type: "js",
		fullpath: moduleBase + "xforms.js",
		requires: ["xforms-model", "xforms-navigable-control-list"]
	});
	loader.addModule({
		name: "xforms-conditional-invocation",
		type: "js",
  ...
  ///The XForms loading of external data js files
	...
	loader.addModule({
		name: "functions-hmac",
		type: "js",
		fullpath: moduleBase + "../functions/xforms/hmac.js",
		requires: ["xforms-core-function-library", "xpath-extension-md5", "xpath-extension-sha"]
	});
	loader.addModule({
		name: "xpath-extension-md5",
		type: "js",
		fullpath: moduleBase + "../third-party/md5.js"
	});
	loader.addModule({
		name: "xpath-extension-sha",
		type: "js",
		fullpath: moduleBase + "../third-party/jsSHA/src/sha.js"
	});

	loader.addModule({
		name: "xforms-dom-util",
		type: "js",
		fullpath: moduleBase + "../ajaxslt/util.js"
	});
	loader.addModule({
		name: "xforms-dom-xml",
		type: "js",
		fullpath: moduleBase + "../ajaxslt/xmltoken.js"
	});
	loader.addModule({
		name: "xforms-dom",
		type: "js",
		fullpath: moduleBase + "../ajaxslt/dom.js",
		requires: ["xforms-dom-util", "xforms-dom-xml"]
	});
	loader.addModule({
		name: "xforms-xpath",
		type: "js",
		fullpath: moduleBase + "../ajaxslt/xpath.js"
	});
	loader.addModule({
		name: "xforms-ajaxslt-improvements",
		type: "js",
		fullpath: moduleBase + "ajaxslt-improvements.js",
		requires: ["xforms-dom", "xforms-xpath"]
	});
	loader.addModule({
		name: "xforms-core-function-library",
		type: "js",
		fullpath: moduleBase + "xforms-core-function-library.js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "pe-value.js"
	});
	loader.addModule({
		name: "xforms-input-value",
		type: "js",
		fullpath: moduleBase + "input-value.js"
	});
	loader.addModule({
		name: "xforms-input-value-boolean",
		type: "js",
		fullpath: moduleBase + "input-value-boolean.js"
	});
	loader.addModule({
		name: "xforms-output-value",
		type: "js",
		fullpath: moduleBase + "output-value.js",
		requires: ["output-googleMap"]
	});
	loader.addModule({
		name: "xforms-range-value",
		type: "js",
		fullpath: moduleBase + "range-value.js",
		requires: ["slider", "range-googleMap"]
	});
	loader.addModule({
		name: "xforms-trigger-minimal",
		type: "js",
		fullpath: moduleBase + "TriggerMinimalMixin.js"
	});
	...
	//
	loader.addModule({
		name: "functions-format-number",
		type: "js",
		fullpath: moduleBase + "../functions/xslt20/format-number.js"
	});

	// Map controls
	loader.addModule({
		name: "output-googleMap",
		type: "js",
		fullpath: moduleBase + "../extensions/output-googleMap.js",
		requires: ["base-googleMap"]
	});
	loader.addModule({
		name: "range-googleMap",
		type: "js",
		fullpath: moduleBase + "../extensions/range-googleMap.js",
		requires: ["base-googleMap"]
	});
	loader.addModule({
		name: "base-googleMap",
		type: "js",
		fullpath: moduleBase + "../extensions/base-googleMap.js",
		requires: ["hint-googleMap"]
	});
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "container.js"
	});
	loader.addModule({
		name: "xforms-group",
		type: "js",
		fullpath: moduleBase + "Group.js",
	...
	loader.addModule({
		name: "backplane-case",
		type: "js",
		fullpath: moduleBase + "../_backplane/case.js"
	});
	loader.addModule({
		name: "xforms-case",
		type: "js",
		fullpath: moduleBase + "case.js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "optional-binding.js",
		requires: ["xforms-mip-handler"]
	});
	loader.addModule({
		name: "xforms-src-mixin",
		type: "js",
	...
	loader.addModule({
		name: "xforms-control",
		type: "js",
		fullpath: moduleBase + "Control.js",
		requires: ["xforms-mip-eventtarget", "dirtystate", "xforms-model", "xforms-processor", "xforms-state", "xforms-utils"]
	});
	loader.addModule({
		name: "xforms-navigable-control",
		type: "js",
		fullpath: moduleBase + "navigable-control.js",
		requires: ["xforms-utils", "xforms-processor"]
	});
	loader.addModule({
		name: "xforms-navigable-control-list",
		type: "js",
		fullpath: moduleBase + "navigable-control-list.js",
	...
	loader.addModule({
		name: "xforms-actions",
		type: "js",
		fullpath: moduleBase + "actions.js",
		requires: ["container", "xforms-message-css", "yui-style-css", "xforms-notify", "message-yui"]
	});
	loader.addModule({
		name: "xforms-action",
		type: "js",
		fullpath: moduleBase + "xf-action.js",
		requires: ["ub-listener", "ub-threads", "xforms-actions"]
	});
	loader.addModule({
		name: "xforms-model-actions",
		type: "js",
		fullpath: moduleBase + "modelactions.js",
		requires: ["xforms-actions", "xforms-processor"]
	});

	loader.addModule({
		name: "xforms-setindex",
		type: "js",
		fullpath: moduleBase + "setindex.js",
		requires: ["xforms-instance", "xforms-actions"]
	});
	loader.addModule({
		name: "xforms-setvalue",
		type: "js",
		fullpath: moduleBase + "setvalue.js",
		requires: ["xforms-instance", "xforms-actions"]
	});
	loader.addModule({
		name: "xforms-setfocus",
		type: "js",
		fullpath: moduleBase + "setfocus.js",
		requires: ["xforms-instance", "xforms-actions"]
	});
	loader.addModule({
		name: "xforms-insert",
		type: "js",
		fullpath: moduleBase + "insert.js",
		requires: ["xforms-instance", "xforms-actions"]
	});
	loader.addModule({
		name: "xforms-delete",
	...
	loader.addModule({
		name: "xforms-toggle",
		type: "js",
		fullpath: moduleBase + "toggle.js",
		requires: ["xforms-actions", "libxh-namespace-manager"]
	});

	loader.addModule({
		name: "backplane-multimap",
		type: "js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "../_backplane/select.js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "commonselect.js",
		requires: ["xforms-dropbox-yui"]
	});
	loader.addModule({
		name: "xforms-select1",
		type: "js",
		fullpath: moduleBase + "select1.js",
		requires: ["ub-dom2events", "backplane-select", "finite-control", "xforms-common-select"]
	});
	loader.addModule({
		name: "xforms-select",
		type: "js",
		fullpath: moduleBase + "select.js",
		requires: ["ub-dom2events", "backplane-select", "finite-control", "xforms-common-select"]
	});
	loader.addModule({
		name: "xforms-item",
		type: "js",
		fullpath: moduleBase + "item.js",
		requires: ["ub-dom2events"]
	});
	loader.addModule({
		name: "xforms-copy",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "../_platform/yui/xforms-submission-yui.js",
		requires: ["connection"]
	});

	loader.addModule({
		name: "xforms-dropbox-yui",
		type: "js",
		fullpath: moduleBase + "../_platform/yui/dropbox-yui.js",
		requires: ["menu"]
	});
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "../extensions/input-color.js",
		requires: ["yui-color", "yui-colorpicker-css"]
	});
	loader.addModule({
		name: "yui-color",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/colorpicker/colorpicker-min.js",
		requires: ["yui-slider"]
	});
	loader.addModule({
		name: "yui-slider",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/slider/slider-min.js"
	});
	loader.addModule({
		name: "yui-colorpicker-css",
		type: "css",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "../extensions/input-calendar.js",
		requires: ["yui-element", "yui-dom-event", "yui-button", "yui-container-core", "yui-calendar", "yui-calendar-css", "yui-button-css"]
	});
	loader.addModule({
		name: "yui-calendar",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/calendar/calendar-min.js"
	});
	loader.addModule({
		name: "yui-container-core",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/container/container_core-min.js"
	});
	loader.addModule({
		name: "yui-button",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/button/button-min.js"
	});
	loader.addModule({
		name: "yui-dom-event",
		type: "js",
	...
	loader.addModule({
		name: "yui-element",
		type: "js",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/element/element-min.js"
	});
	loader.addModule({
		name: "yui-calendar-css",
		type: "css",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/calendar/assets/skins/sam/calendar.css"
	});
	loader.addModule({
		name: "yui-button-css",
		type: "css",
	...
	loader.addModule({
		name: "yui-style-css",
		type: "css",
		fullpath: moduleBase + "../_platform/yui/message-panel.css"
	});
	loader.addModule({
		name: "xforms-notify",
		type: "js",
		fullpath: moduleBase + "../_backplane/notify.js"
	});
	loader.addModule({
		name: "message-yui",
		type: "js",
		fullpath: moduleBase + "../_platform/yui/message.js"
	});
	loader.addModule({
		name: "xforms-help-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/help.css"
	});
	loader.addModule({
		name: "xforms-hint-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/hint.css"
	});
	loader.addModule({
		name: "xforms-message-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/message.css"
	});

	// Theming work
	loader.addModule({
		name: "xforms-actions-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/actions.css"
	});
	loader.addModule({
		name: "xforms-alert-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/alert.css"
	});
	loader.addModule({
		name: "xforms-control-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/control.css"
	});
	loader.addModule({
		name: "xforms-output-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/output.css"
	});
	loader.addModule({
		name: "xforms-select-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/select.css"
	});
	loader.addModule({
		name: "xforms-submission-css",
		type: "css",
		fullpath: moduleBase + "../../assets/style/submission.css"
	});

	loader.addModule({
		name: "xforms-hint",
		type: "js",
		fullpath: moduleBase + "HintMixin.js",
	...
	loader.addModule({
		name: "xforms-help",
		type: "js",
		fullpath: moduleBase + "HelpMixin.js",
