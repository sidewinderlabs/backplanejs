...
function runTheTests() {
  ...
  //
	loader.addModule({
		name: "logger-css",
		type: "css",
		fullpath: "http://yui.yahooapis.com/2.8.0/build/logger/assets/logger.css"
	});
	loader.addModule({
		name: "test-logger-css",
		type: "css",
  ...
  //
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "ut-xforms-library-loaded.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	loader.addModule({
		name: "ux-ut-xpath-core-functions",
		type: "js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "ut-xslt20-functions.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-NamespaceManager",
		type: "js",
		fullpath: moduleBase + "ut-NamespaceManager.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-event-target",
		type: "js",
		fullpath: moduleBase + "ut-event-target.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-path-to-module",
		type: "js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "ut-instance-standalone.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-model-standalone",
		type: "js",
		fullpath: moduleBase + "ut-model-standalone.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	...
	loader.addModule({
		name: "ux-ut-reset",
		type: "js",
		fullpath: moduleBase + "ut-reset.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "ut-finite-control.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-delete-nodes",
		type: "js",
		fullpath: moduleBase + "ut-delete-nodes.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-insert-nodes",
		type: "js",
		fullpath: moduleBase + "ut-insert-nodes.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-extended-dom-navigation",
		type: "js",
		fullpath: moduleBase + "ut-extended-dom-navigation.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-dirtystate",
		type: "js",
		fullpath: moduleBase + "ut-dirtystate.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-xforms-submission-stub",
		type: "js",
		fullpath: moduleBase + "xforms-submission-stub.js",
		requires: []
	});

	loader.addModule({
		name: "ux-ut-xforms-submission",
		type: "js",
	...
	loader.addModule({
		...
		type: "js",
		fullpath: moduleBase + "ut-xforms-submission-header.js",
		requires: ["yuitest", "logger-css", "test-logger-css", "ux-ut-xforms-submission-stub"]
	});
	...
	loader.addModule({
		name: "ux-ut-pe-value",
		type: "js",
		fullpath: moduleBase + "ut-pe-value.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	...
	loader.addModule({
		name: "ux-ut-Control",
		type: "js",
		fullpath: moduleBase + "ut-Control.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	...
	loader.addModule({
		name: "ux-ut-setfocus",
		type: "js",
		fullpath: moduleBase + "ut-setfocus.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-container",
		type: "js",
		fullpath: moduleBase + "ut-container.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-formsProcessor",
		type: "js",
		fullpath: moduleBase + "ut-formsProcessor.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-types-validator",
		type: "js",
		fullpath: moduleBase + "ut-types-validator.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-mip-handler",
		type: "js",
		fullpath: moduleBase + "ut-MIPHandler.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-mip-eventtarget",
		type: "js",
		fullpath: moduleBase + "ut-MIPEventTarget.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-optional-binding",
		type: "js",
		fullpath: moduleBase + "ut-optional-binding.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-ajaxslt-improvements",
		type: "js",
		fullpath: moduleBase + "ut-ajaxslt-improvements.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
	...
	loader.addModule({
		name: "ux-ut-ux-utils",
		type: "js",
		fullpath: moduleBase + "ut-ux-utils.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});

	loader.addModule({
		name: "ux-ut-navigable-control-list",
		type: "js",
		fullpath: moduleBase + "ut-navigable-control-list.js",
		requires: ["yuitest", "logger-css", "test-logger-css"]
	});
